...
} : {logging: false, typeValidation: true}; // typeValidation makes it so i cannot misspell an enum.  it does doesn't mandate a defaultValue, it simply errors out.
...
const UsersModel = sequelizeDatabase.define('Users', {
  ...
  role: {
    ...
    defaultValue: 'user', // if I forget to add a role on user signup, user is assigned by default
  },
  token: {
